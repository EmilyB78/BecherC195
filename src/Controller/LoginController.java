...
public class loginScreen implements Initializable {
    ...
    private void loginButton(ActionEvent event) throws SQLException, IOException, Exception {
        try {
            ...
            ObservableList<Appointments> getAllAppointments = ApptAcc.getAllAppointments();
            ...
            int userId = UserAcc.validateUser(usernameInput, passwordInput);
